...
#### 복합 인덱스 관리를 위한 명시적 메서드 네이밍 컨벤션 수립
...
<Tags
  metadata={["general", "backend-agnostic", "standbylab"]}
  tags={["backend", "feature", "@shepherd23"]}
  tagColorScheme={values.tagColorScheme}
/>
...
- [`BanditClient`](https://01joseph-hwang10.github.io/docs/career-description/pickhound#bandit-engine-서비스와의-연동을-위한-http-client-구현)
- [`objectFromCamelToSnake`](https://01joseph-hwang10.github.io/docs/career-description/pickhound#bandit-engine-서비스와의-연동을-위한-http-client-구현)
- [`objectFromSnakeToCamel`](https://01joseph-hwang10.github.io/docs/career-description/pickhound#bandit-engine-서비스와의-연동을-위한-http-client-구현)
...
# - _INSTANCE_TEMPLATE_NAME: GCE instance template name (only needed when deploy to GCE)
...
steps:
  ...
  - name: "gcr.io/google.com/cloudsdktool/cloud-sdk:slim"
    ...
    env:
      ...
      - "INSTANCE_TEMPLATE_NAME=${_INSTANCE_TEMPLATE_NAME}"
...
# - INSTANCE_TEMPLATE_NAME: instance template name or prefix (only required when "DEPLOY_TO" is 'GCE')
...
if [ "$DEPLOY_TO" == "GCE" ]; then
  ...
  # Retrieve a name of the previous instance template
  INSTANCE_TEMPLATE_NAME=$(
      gcloud compute instance-templates list \
          --filter="name~'${INSTANCE_TEMPLATE_NAME}*'" \
...
- [`cloudbuild.yaml`](https://01joseph-hwang10.github.io/docs/career-description/pickhound#긴-프로세스를-담당하는-worker-인프라-구축)
- [`deploy.sh`](https://01joseph-hwang10.github.io/docs/career-description/pickhound#긴-프로세스를-담당하는-worker-인프라-구축)
- [`Dockerfile`](https://01joseph-hwang10.github.io/docs/career-description/pickhound#긴-프로세스를-담당하는-worker-인프라-구축)
