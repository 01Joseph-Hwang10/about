...
개발하고자 하는 기능이 다소 복잡했지만, OOP와 모듈화에 대한 계속적인 고민을 통해 코드의 Readability와 유지보수의 용이함을 보장할 수 있었습니다. 또한 작업을 진행하면서 FLUX, MVP 등 코드 패턴에 관한 깊은 고찰과 Javascript, React, Redux, Web Component 의 동작 원리에 대한 이해를 크게 높일 수 있었습니다.
